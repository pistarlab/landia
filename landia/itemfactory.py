...
class ShapeFactory:
    ...
    @classmethod
    def attach_circle(cls, obj: GObject, radius=5, pos=(0, 0), collision_type=0, friction=0.2):
    ...
    @classmethod
    def attach_rectangle(cls, obj: GObject, width=32, height=32, collision_type=0):
        h = height/2
        w = width/2
        p1 = Vector2(-w, -1 * h)
        p2 = Vector2(-1 * w, h)
    ...
    @classmethod
    def attach_triangle(cls, obj: GObject, side_length=12, collision_type=0):
    ...
    @classmethod
    def attach_poly(cls, obj: GObject, size=10, num_sides=3, collision_type=0):
        verts = []
